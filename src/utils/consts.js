export const mainUrl = 'https://aura-residence.roitiv.com/projektet';
...
export const homepage = `https://aura-residence.roitiv.com/projektet`
export const galleryDir = 'assets/gallery/'
export const imagePath = `https://aura-residence.roitiv.com/projektet/objektetImg/`
export const pdfPath = `https://aura-residence.roitiv.com/projektet/pdf/`
