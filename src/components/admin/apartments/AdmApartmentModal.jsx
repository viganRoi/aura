            ...
            >
              ...
              {/* <TextField
                ...
                onChange={(e) => {
                  ...
                  const suffix = "-orientimi.png";
                  setApartmentData({
                    ...apartmentData,
                    apartmentPositionImageUrl: inputValue,
                  });
                }}
                onBlur={() => {
                  const suffix = "-orientimi.png";
                  if (!apartmentData.apartmentPositionImageUrl.endsWith(suffix)) {
                    setApartmentData((prev) => ({
                      ...prev,
                      apartmentPositionImageUrl: prev.apartmentPositionImageUrl + suffix,
                    }));
                  }
                }}
                InputProps={{
                    ...
                    endAdornment: (
                      <InputAdornment position="end">
                        <Tooltip title='Check if Virtual Tour Link exists'>
                          <IconButton onClick={() => window.open(`${mainUrl}${vTourPath}/${apartmentData.vtourUrl}`, "_blank")}>
                            <ViewInAr />
                          </IconButton>
                        </Tooltip>
                      </InputAdornment>
